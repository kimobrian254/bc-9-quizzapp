...
def take_quiz(quiz_name):
    print colored("\tThe Quizz begins in 10 Seconds", "blue")
    print colored('\tNote: Enter a choice and press Enter', "yellow")
    ...
    for quiz in quizes:
        ...
        ans = nonBlockingRawInput(quiz['choices'], quiz['question'], quiz['time'])
    ...
    results = [["Timed Out Questions", result[0]], ["Wrong Score", result[1]], ["Invalid Answers",result[2]], ["Total Questions", str(total_questions)], ["Correct Score",str(result[3])+"/"+str(total_questions)]]
    print("\n")
...
def list_remote_quizzes():
    ...
    click.echo(click.style("\t\t<Download the querries to access them>", fg="yellow"))
